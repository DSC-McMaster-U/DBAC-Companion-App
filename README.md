...
| ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="images/RyanZhang.PNG" alt="Ryan Zhang" width="100"/> <br/> **Ryan Zhang** <br/> <i>Project Manager & DevOps</i> | ![Google Cloud](https://img.shields.io/badge/GoogleCloud-%234285F4.svg?style=for-the-badge&logo=google-cloud&logoColor=white) | <ul><li>Project Architect, Cloud Development, Program Management</li><li><a href="https://github.com/DSC-McMaster-U/DBAC-Companion-App/pull/31">#1: MVP PR</a></li><li><a href="https://github.com/DSC-McMaster-U/DBAC-Companion-App/pull/25">#2: Backend Bug Fixes, Facility Functionality, Front-End → Backend</a></li></ul> |
